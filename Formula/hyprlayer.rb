...
class Hyprlayer < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "caa08ff0589c6d66e57a75b84fa481ad3e1ebca027853610f77c2506643e9351"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "958b642994e99696c24ec9a7e05fb84c1518b9935033a55430c52682fd98b697"
    end

    on_intel do
      url "https://github.com/BrightBlock/hyprlayer-cli/releases/download/v#{version}/hyprlayer-x86_64-unknown-linux-gnu"
      sha256 "c73ad4ae0d322f60c256228411aa25b14e6162da3b33e7f88f0c21ee6289c8a5"
    end
  end
